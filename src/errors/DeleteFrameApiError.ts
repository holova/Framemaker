export default class DeleteFrameApiError extends Error implements DeleteFrameErrorPort {
  payload: DeleteFrameErrorPayload = {};
  ...
  constructor(errors: string[]) {
    ...
    errors.forEach((e) => {
      ...
      if (e === 'button.forbidden') {
        this.payload.frame = (this.payload.frame || []).concat('You do not have permission to delete the button');
      }
